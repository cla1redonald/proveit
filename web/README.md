...
- **Vitest** + React Testing Library — 337 tests across unit + integration
...
└── tests/                        # Unit + integration (337 tests) + e2e/
```
